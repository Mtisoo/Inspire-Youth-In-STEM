...
if (gross_income <= 10000):
    net_income=(-(5*gross_income)/100 +gross_income)
    print("Your net income is: ", net income)
elif (gross_income >=10000) & (gross_income <= 150000):
    net_income = ((-(16*gross_income)/100) + gross income)
    ...
    net_income =( gross_income - ((19*gross_income)/100))
    print("Since your gross income is {} your net income is{}."format. gross_income,net_income )
else :
    net_income = (gross_income - ((30*gross_income)/100))
    print("Since your gross income is {} your net income is{}."format. gross_income,net_income )
